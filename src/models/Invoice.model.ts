...
export interface IInvoice extends Document {
  orderId?: Types.ObjectId; // <-- link to order
  accountId?: Types.ObjectId;
  invoiceNumber: string;
  guestToken?: string; // <-- for guest public view
  customerContact?: {
    // store minimal contact for guest view
    name?: string;
    email?: string;
    phone?: string;
  };
  ...
  createdBy?: Types.ObjectId; // admin id who created
}
